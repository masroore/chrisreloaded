        ...
        function() {
          ...
          jQuery('#plugin_submit').on(
              ...
              function(e) {
                ...
                // check if plugin as a target file to be opened rather than
                // following the traditionnal workflow
                var _target = "";
                var _definedTarget = jQuery(_visible_panel.parent()[0]).attr(
                    'data-target');
                if (_definedTarget) {
                  _target = _definedTarget;
                }
                if (_target == "") {
